...
/**
 * JSON Binding for an Identifier / Vertex
 *
 * @author Leonard Renners
 *
 */
public class JsonBindingIdentifier {
	 ...
	 *            The raw XML String
	 */
	public JsonBindingIdentifier(String typename, HashMap<String, String> properties, String rawData) {
