...
public final class FileUtils {
	 ...
	 *            the directory, for which subdirectories will be searched
	 ...
	 *            the directory, in which the subdirectory will be searched
	...
	/**
	 * Returns a list of {@link URL} instances, containing all jar URL from the procedure directory.
	 * 
	 * @param directory
	 *            the directory, in which JAR file swill be searched
	 ...
	 * 
	 * Appends the given directory to the java.library.path and FORCES the JVM to reload all native library folder.
	 * 
	 * @param directoryPath
	 */
	...
	/**
	 * @param file
	 * @return The Filename of a URL (removing the whole PATH)
	 */
	public static String getFileName(URL file) {
