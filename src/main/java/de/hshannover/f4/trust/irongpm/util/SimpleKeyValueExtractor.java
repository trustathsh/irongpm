...
/**
 * Extracts information from XML documents into a set of key/value pairs. A <tt>SimpleKeyValueExtractor</tt> is only
 * capable of extracting information from "simple" XML documents. "Simple" means:<br>
...
public class SimpleKeyValueExtractor extends AbstractXMLDataExtractor {
	 ...
	 */
	private static void collectProperties(Node node, String parentPath, Map<String, String> properties) {
	 ...
	 */
	private static void collectXmlAttributes(Node node, String parentPath, Map<String, String> properties) {
