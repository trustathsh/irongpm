...
public final class ReflectionUtils {
	...
	/**
	 * Checks a list of given class names if they implement a given interface and loads it via reflection.
	 * 
	 * @param classLoader
	 *            a given {@link ClassLoader} instance (configured with specific URLs for JARs etc.)
	 * @param classNames
	...
	public static <T> T loadClass(ClassLoader classLoader, List<String> classNames, Class<T> t) {
	 ...
	 * @throws IOException
	 *             if the reading of the jar file fails
	 */
	 ...
	 */
	public static boolean implementsInterface(Class<?> givenClass, Class<?> interfaceClass) {
		List<Class<?>> interfacesList = Arrays.asList(givenClass.getInterfaces());
		return interfacesList != null && interfacesList.contains(interfaceClass);
	}
}
